...
class Cart(FptBaseModel):
    ...
    user = models.ForeignKey("users.User", on_delete=models.SET_NULL, null=True, blank=True, related_name="carts")
...
class CartItem(FptBaseModel):
    ...
    product = models.ForeignKey("products.Product", on_delete=models.CASCADE, related_name="product_item")
